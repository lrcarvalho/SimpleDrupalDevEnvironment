...
#pleae inset your person key here
default_ssh_key_path="/home/vagrant/.ssh/private_key.ppk"
private_ssh_key=""


#TODO
# CREATE PERSONAL SETTINGS FUNCTIONS
# SSH KEY
# GIT
...
private_key_go() {
	if [ ! -f "${default_ssh_key_path}" ]; then
		echo "${private_ssh_key}" >> ${default_ssh_key_path}
	fi
	}
